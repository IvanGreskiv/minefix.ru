<div class="userinfo">
		...
		<div class="rcol">
			<ul class="reset">
                ...
                <li><span class="grey">Дата посещения:</span> <b>{lastdate}</b>, <li><span class="grey">Статус: [online]</span><span class="badge green">Online</span>[online]</li> <li><span class="grey"> [offline][/online]</span><span class="badge">Offline</span>[/offline]</li>
